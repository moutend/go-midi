...
func TestParseEvent(t *testing.T) {
	stream := []byte{0x00, 0xff, 0x02, 0x12, 0x6f, 0x70, 0x79, 0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x28, 0x43, 0x29, 0x20, 0x32, 0x30, 0x31, 0x37}
	event, err := parseEvent(stream, 123)
	if err != nil {
		t.Fatal(err)
	}
